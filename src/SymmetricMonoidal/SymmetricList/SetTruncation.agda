...
FMSetIso∥SList∥ : Iso ∥ SList A ∥₂ (FMSet A)
FMSetIso∥SList∥ = iso ∥SList∥→FMSet FMSet→∥SList∥ section retract

FMSet≡∥SList∥ : ∥ SList A ∥₂ ≡ FMSet A
FMSet≡∥SList∥ = isoToPath FMSetIso∥SList∥
